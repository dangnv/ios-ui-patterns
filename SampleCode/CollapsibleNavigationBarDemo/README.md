...
Before we start working on our collapsible Navigation Bar, we'll first need a UITableViewController with enough items in it for us to scroll through.  For this post, we won't review how to do that - as we want to focus on the Navigation Bar bits.  However, feel free to use this <a src="https://github.com/ccabanero/ios-ui-patterns/blob/master/SampleCode/collapsenav_Xcode_starter.zip">sample project</a> to get started and follow along.
